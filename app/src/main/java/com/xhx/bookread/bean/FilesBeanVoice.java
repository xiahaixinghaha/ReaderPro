...
@Table(name = DatabaseConfig.FILES_TAB_NAME_VOICE)
public class FilesBeanVoice extends SugarRecord implements Serializable {
    @Unique
    ...
    public FilesBeanVoice(){

    }
    public FilesBeanVoice(String filePath, String fileName, String fileType, String addDate, int classify, int folderIndex) {
