...
@Table(name = DatabaseConfig.FILES_TAB_NAME)
public class FilesBean extends SugarRecord implements Serializable {
    @Unique
    ...
    public FilesBean(String filePath, String fileName, String fileType, String addDate, int classify, int folderIndex) {
